...
export const Chart = () =>{
      ...
      datasets: [
        {
          ...
          borderWidth: 2,
          pointRadius: 6,
          pointBackgroundColor: costs.map(cost => cost === 4.25 ? 'red' : 'rgba(75, 192, 192, 1)'),
        },
      ],
    };
    ...
    return <>
    <div className="flex-row md:flex justify-between items-center px-5 mt-10">
        ...
        <div className="bg-[#bfb293] w-full mx-auto mt-5 md:w-[45%]  rounded-3xl"><div className="mx-auto">
        <Line data={data} options={options} />
      </div></div>
    </div>
